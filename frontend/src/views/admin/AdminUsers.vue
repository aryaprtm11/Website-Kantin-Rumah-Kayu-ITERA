    ...
    <main class="flex-1 ml-0 lg:ml-[280px] p-4 lg:p-8">
      ...
      >
        ...
        <div class="flex gap-2 items-center">
          ...
          <button
            class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg font-medium transition-all hover:bg-green-700"
            @click="openAddModal"
          >
            <Plus :size="16" />
      ...
      <div class="flex flex-col gap-4">
        <!-- Search & Filter -->
        <div
          class="bg-white rounded-lg p-4 border border-gray-200 flex gap-3 flex-wrap items-center"
        >
          ...
          <div class="flex gap-2 flex-wrap">
            <button
              ...
              :key="role.value"
              :class="[
                'px-3 py-2 rounded-lg text-sm font-medium cursor-pointer transition-all',
                currentFilter === role.value
              ...
              <table class="w-full border-collapse">
                <thead>
                  <tr class="bg-gray-50 border-b border-gray-200">
                    <th
                      class="text-left py-3 px-4 text-gray-700 font-semibold text-xs whitespace-nowrap"
                    >
                      ID
                    </th>
                    <th
                ...
                <tbody class="divide-y divide-gray-100">
                  ...
                  >
                    <td
                      class="py-4 px-4 border-b border-gray-200 text-gray-900"
                    >
                      #{{ user.id }}
                    </td>
                    <td class="py-4 px-4 border-b border-gray-200">
                      <div class="flex items-center gap-3">
                        <div
                          class="w-9 h-9 rounded-full bg-gradient-to-br from-green-500 to-green-700 text-white flex items-center justify-center font-bold text-sm flex-shrink-0"
                        >
                    ...
                    <td
                      class="py-4 px-4 border-b border-gray-200 text-sm text-gray-600"
                    >
                    ...
                    <td class="py-4 px-4 border-b border-gray-200">
                      <span
                        v-if="user.tenant"
                        class="inline-block px-3 py-1 rounded-xl text-xs font-semibold bg-blue-100 text-blue-800"
                      >
                        {{ user.tenant.name }}
                      </span>
                    ...
                    <td class="py-4 px-4 border-b border-gray-200">
                      <div class="flex gap-2">
                        <button
                          class="w-9 h-9 inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 text-blue-900 transition-all hover:-translate-y-0.5 hover:shadow-md"
                        ...
                        <button
                          ...
                          :class="[
                            'w-9 h-9 inline-flex items-center justify-center rounded-lg transition-all hover:-translate-y-0.5 hover:shadow-md',
                            user.is_active
    ...
    >
      ...
      >
        <div class="flex justify-between items-center mb-6">
          ...
          <button
            class="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-100 text-gray-600 text-2xl"
            @click="closeModal"
          >
            ✕
          </button>
        ...
        <form @submit.prevent="handleSubmit">
          <div class="mb-4">
            <label
              for="name"
              class="block font-medium text-gray-700 mb-2 text-sm"
              >Nama Lengkap *</label
            >
            <input
              id="name"
          ...
          <div
            v-if="formError"
            class="px-4 py-3 bg-red-100 text-red-900 rounded-lg mb-4 text-sm"
          >
            {{ formError }}
          </div>
          ...
          <div class="flex gap-4 mt-6">
            <button
              type="button"
              class="flex-1 px-4 py-3 bg-white border border-gray-300 rounded-lg font-semibold cursor-pointer transition-all hover:bg-gray-50"
              @click="closeModal"
            >
              Batal
            </button>
            <button
              type="submit"
              class="flex-1 px-4 py-3 bg-gradient-to-r from-green-500 to-green-700 text-white rounded-lg font-semibold transition-all hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
              :disabled="submitting"
            >
              {{
