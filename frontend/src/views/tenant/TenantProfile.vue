        ...
        <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
          ...
          <div class="bg-white rounded-lg p-5 border border-gray-200">
            <div class="flex flex-col items-center text-center mb-5 pb-5 border-b border-gray-100">
              ...
              <p class="inline-block px-2.5 py-1 bg-green-50 text-green-700 rounded-full text-xs font-medium border border-green-200">Tenant Admin</p>
            </div>

            <!-- Account Stats -->
            <div class="space-y-3">
              <div class="flex justify-between items-center">
                <span class="text-gray-600 text-xs font-medium">Total Pesanan</span>
